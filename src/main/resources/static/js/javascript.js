...
function login() {
  ...
  fetch("https://zescotrackingsystem.herokuapp.com/users/login", {
    method: "post",
    headers: {
...
function registerUser() {
  ...
  fetch("https://zescotrackingsystem.herokuapp.com/users/create", {
    method: "post",
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
function addEquip() {
  ...
  fetch("https://zescotrackingsystem.herokuapp.com/equips/read")
    ...
    .then(equips => {
      ...
      fetch("https://zescotrackingsystem.herokuapp.com/equips/create", {
        method: "post",
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
...
function addIssue() {
  ...
  fetch("https://zescotrackingsystem.herokuapp.com/issues/read")
    .then(response => response.json())
    .then(issues => {
      var issuesId = 0;
      if (issues.length > 0) {
      ...
      console.log(info)
      fetch("https://zescotrackingsystem.herokuapp.com/issues/create", {
        method: "post",
        headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json'
...
function deleteIssue(e) {
  ...
  fetch("https://zescotrackingsystem.herokuapp.com/issues/delete", {
    method: "delete",
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
function deleteEquip(e) {
  ...
  fetch("https://zescotrackingsystem.herokuapp.com/equips/delete", {
    method: "delete",
    headers: {
      'Accept': 'application/json',
      'Content-Type': 'application/json'
...
function updateIssue() {
  ...
  if (role.roleId !== '1') {
    ...
    fetch("https://zescotrackingsystem.herokuapp.com/issues/update", {
      method: "put",
      headers: {
        'Accept': 'application/json',
        'Content-Type': 'application/json'
